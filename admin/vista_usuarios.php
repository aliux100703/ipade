    ...
    <div class="container">
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                echo "<tr><th>ID</th><th>Nombre</th><th>Correo</th><th>Rol</th><th>Acciones</th></tr>";
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <button type='button' class='btn btn-info' data-toggle='modal' data-target='#modalCambiarContrasena' onclick='abrirModal(" . $row["id"] . ")'>Cambiar Contraseña</button>
                </td>";
                    echo "</tr>";
                }
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formCambiarContrasena">
                            ...
                            Confirmar Contraseña: <input type="password" id="confirmarContrasena"><br>
        ...
        $(document).ready(function() {
            $('#formCambiarContrasena').submit(function(e) {
                ...
                if (nuevaContrasena == confirmarContrasena) {
                    $.ajax({
                        type: 'POST',
                        url: 'procesar_cambio_contrasena.php',
                        data: {
                            userId: userId,
